...
class ProductManager {
    ...
    async addProduct(product) {
        try {
            ...
            for (const key in product) {
                if (key !== "id" && key !== "title" && key !== "description" && key !== "price" && key !== "code" && key !== "thumbnail" && key !== "status" && key !== "stock" && key !== "category") {
    ...
    async updateProduct(id, product) {
        try {
            ...
            for (const key in product) {
                if (
                    key !== "id" && key !== "title" && key !== "description" && key !== "price" && key !== "code" && key !== "thumbnail" && key !== "status" && key !== "stock" && key !== "category"
                ) {
                    return `${key} is not an allowed field`
                }
            }
